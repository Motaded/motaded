...
/* themes/custom/motaded_theme/templates/views/views-view--services--block_2.html.twig */
class __TwigTemplate_d68506a1f073ed1959f05256e4ac399c extends Template
{
...
($context["dom_id"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("js-view-dom-id-" . ($context["dom_id"] ?? null))) : (""))];
  ...
  ";
        ...
        if ((($tmp = ($context["rows"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 69
            yield "    <div class=\"view-content grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-6\">
      ";
            // line 70
...
";
    ...
    {
        return "themes/custom/motaded_theme/templates/views/views-view--services--block_2.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/motaded_theme/templates/views/views-view--services--block_2.html.twig", "/var/www/html/web/themes/custom/motaded_theme/templates/views/views-view--services--block_2.html.twig");
    }
