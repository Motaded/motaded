...
/* themes/custom/motaded_theme/templates/paragraphs/paragraph--card.html.twig */
class __TwigTemplate_e1225ba765de6e79ae6a38da7de112ae extends Template
{
...
($context["paragraph"] ?? null), "isPublished", [], "method", false, false, true, 51)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("paragraph--unpublished") : ("")), "group h-full rounded-2xl bg-white/95 p-6 shadow-sm ring-1 ring-black/5 backdrop-blur transition hover:shadow-md hover:-translate-y-[2px] focus-within:shadow-md focus-within:-translate-y-[2px]"];
        // line 55
...
";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 58
        yield "      <div class=\"flex flex-col items-center text-center gap-4\">
        <div class=\"grid place-items-center h-16 w-16 rounded-xl bg-primary-50 ring-1 ring-primary-200\">
          ";
        // line 60
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_media", [], "any", false, false, true, 60), "html", null, true);
        yield "
        </div>
        <h2 class=\"text-lg font-semibold text-gray-900\">
          ";
        // line 63
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_title", [], "any", false, false, true, 63), 0, [], "any", false, false, true, 63), "html", null, true);
        yield "
        </h2>
        ...
        yield "\" class=\"mt-2 inline-flex items-center gap-1 text-primary-600 font-medium hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-300 rounded\">
          ";
        // line 69
        ...
        yield "
          <img alt=\"\" width=\"16\" height=\"16\" src=\"/themes/custom/motaded_theme/img/icon-arrow-down.svg\" class=\"-rotate-90 rtl:rotate-90\"/>
        </a>
      </div>
    ...
    {
        return "themes/custom/motaded_theme/templates/paragraphs/paragraph--card.html.twig";
    }
    ...
    {
        return array (  111 => 69,  107 => 68,  102 => 66,  96 => 63,  90 => 60,  86 => 58,  79 => 57,  73 => 75,  71 => 57,  66 => 56,  54 => 55,  52 => 51,  51 => 50,  50 => 49,  49 => 47,  46 => 5,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "themes/custom/motaded_theme/templates/paragraphs/paragraph--card.html.twig", "/var/www/html/web/themes/custom/motaded_theme/templates/paragraphs/paragraph--card.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = ["set" => 47, "block" => 55];
