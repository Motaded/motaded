...
/* themes/custom/motaded_theme/templates/navigation/links--language-block.html.twig */
class __TwigTemplate_fa95373c457301dc85143edc19cdf99c extends Template
{
...
";
        ...
        if ((($tmp = ($context["links"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            ...
            yield "
  <details 
    class=\"muin-language-switcher\" 
    data-drupal-selector=\"language-switcher\" 
    ";
            // line 47
            yield "    ";
            // line 48
            yield "    >
    <summary class=\"muin-language-switcher__trigger\">
      <span class=\"sr-only current-lang\">";
            // line 50
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Select language, current: @language", ["@language" => ""]));
            yield "</span>
      <span class=\"muin-language-switcher__trigger-content\">
        <span class=\"muin-language-switcher__globe\" aria-hidden=\"true\">
        ...
        <span class=\"muin-language-switcher__label\" aria-hidden=\"true\"></span>
        <span class=\"muin-language-switcher__chevron\" aria-hidden=\"true\">
          <svg viewBox=\"0 0 24 24\" fill=\"none\" aria-hidden=\"true\">
            <path d=\"m6.3 9.3 5.7 5.4 5.7-5.4\" stroke=\"currentColor\" stroke-width=\"1.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\" />
          </svg>
        </span>
      </span>
    </summary>
    <ul class=\"muin-language-switcher__list\" role=\"list\">
      ";
            // line 68
        ...
        <li";
                // line 76
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 76), "addClass", ["muin-language-switcher__item"], "method", false, false, true, 76), "html", null, true);
                yield ">
          ";
                // line 77
                if (CoreExtension::getAttribute($this->env, $this->source, $context["item"], "link", [], "any", true, true, true, 77)) {
                    // line 78
                    yield "            ";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "link", [], "any", false, false, true, 78), "html", null, true);
                    yield "
          ";
                } elseif (CoreExtension::getAttribute($this->env, $this->source,                 // line 79
$context["item"], "text_attributes", [], "any", true, true, true, 79)) {
                    // line 80
                    yield "            <span";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "text_attributes", [], "any", false, false, true, 80), "addClass", ["muin-language-switcher__text", "is-static"], "method", false, false, true, 80), "html", null, true);
                    yield ">";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "text", [], "any", false, false, true, 80), "html", null, true);
                    yield "</span>
          ";
                } else {
                    // line 82
                    yield "            ";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "text", [], "any", false, false, true, 82), "html", null, true);
                    yield "
          ";
                }
                // line 84
    ...
    {
        return "themes/custom/motaded_theme/templates/navigation/links--language-block.html.twig";
    }
    ...
    {
        return array (  127 => 86,  120 => 84,  114 => 82,  106 => 80,  104 => 79,  99 => 78,  97 => 77,  93 => 76,  90 => 75,  88 => 69,  84 => 68,  63 => 50,  59 => 48,  57 => 47,  51 => 32,  49 => 15,  47 => 13,  44 => 5,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "themes/custom/motaded_theme/templates/navigation/links--language-block.html.twig", "/var/www/html/web/themes/custom/motaded_theme/templates/navigation/links--language-block.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = ["if" => 13, "for" => 68];
        static $filters = ["t" => 50, "escape" => 76];
        static $functions = [];
